...
function findWasmBinary() {
    return locateFile('libhfst.wasm');
}
...
(() => {
  // Create a small, never-async wrapper around createHfstModule which
  // checks for callers incorrectly using it with `new`.
  var real_createHfstModule = createHfstModule;
  createHfstModule = function(arg) {
    if (new.target) throw new Error("createHfstModule() should not be called with `new createHfstModule()`");
    return real_createHfstModule(arg);
  }
})();
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createHfstModule;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createHfstModule;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createHfstModule);
